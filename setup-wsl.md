...
You can read more about the differences between the [WSL versions](https://docs.microsoft.com/en-us/windows/wsl/compare-versions).
...
In that case, follow the [instructions](https://aka.ms/wsl2kernel) to update the kernel component.
