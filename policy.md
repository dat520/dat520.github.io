...
- [Grading and Collaboration Policy](#grading-and-collaboration-policy)
  ...
  - [Code Usage and Redistribution](#code-usage-and-redistribution)

Required lab assignments must be completed to satisfaction (passed) in order to sit for the exam.
...
This means that if you cannot make a handin deadline, you can use up to a total of **7 slip days** throughout the semester without failing the course.
...
This includes copying code from former students or from the Internet (e.g., GitHub, Stack Overflow, or similar sources).

**Exception:** You may use generative AI tools as described in the [Generative Models](#generative-models) section below.
...
Any form of cheating or plagiarism, i.e. copying of another student's text or source code, will result in a non-passing grade, and may be reported to the university for administrative processing.
...
You **may** use generative AI tools such as Google's Gemini, Claude, ChatGPT, or GitHub Copilot to assist with your assignments.
This is explicitly allowed and does not constitute plagiarism, provided you meet the following requirements:

1. **Understanding:** You must be able to explain the generated code as if you had written it yourself.
2. **Adaptation:** You are expected to review and adjust any generated code so that it fits the assignment, is logically correct, and is efficient.
3. **Improvement:** You must improve the generated code to meet current best practices and coding standards.
   For example, AI models tend to generate code using legacy styles or suboptimal patterns.
   You must improve such code to meet current best practices, including using recent additions to the standard library and new language features and idioms.
4. **Correctness:** The code must solve the assignment and pass a sufficient number of tests on QuickFeed.
5. **Accountability:** You are responsible for the code you submit, regardless of whether it was AI-generated or written by hand.

**Important distinction:** Using generative AI is different from copying code from other students, former students, or online sources (e.g., GitHub repositories, Stack Overflow).
The latter is prohibited because it circumvents the learning process and violates academic integrity policies.
Generative AI, when used responsibly, can serve as a learning aid similar to reading documentation or discussing concepts with a tutor.

## Code Usage and Redistribution

All course materials, including starter code, skeleton files, and any code distributed to students, are provided exclusively for educational use within this course.
Your solutions and any derivative works based on the course materials are subject to the following restrictions:

1. **Personal and Educational Use Only:** The code you develop for this course may only be used for your own learning and for completing the course assignments.

2. **No Public Distribution:** You are **prohibited** from publishing, sharing, or redistributing your solutions in any form, including but not limited to:
   - Public repositories on GitHub, GitLab, Bitbucket, or similar platforms
   - Code-sharing websites such as Chegg, Course Hero, or Pastebin
   - Personal blogs, websites, or social media

3. **No Sharing with Other Students:** You may not share your code with current or future students of this course, whether directly or indirectly, except as permitted for group assignments with your assigned group members.

4. **Repository Privacy:** Your course repository must remain **private** at all times, both during and after the course.

**Rationale:** Redistributing solutions undermines the learning experience for future students and constitutes a violation of academic integrity.
Violations of this policy may result in disciplinary action in accordance with university regulations.
