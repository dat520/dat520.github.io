...
- A good book is [Pro Git](https://git-scm.com/book).
...
3. Once confirmed, you will get access to your own repository under the [dat520-2026](https://github.com/dat520-2026) organization on GitHub.
...
2. Join our course [Discord server](https://discord.gg/ARmwuane).
...
3. Once connected to the server, please register with our bot, `@dat520-helpbot`, by sending it a direct message or by sending the command in the `#general` channel:
   ...
   Hence, please make sure that you have joined the [`dat520-2026`](https://github.com/dat520-2026) GitHub organization and registered with QuickFeed first.
